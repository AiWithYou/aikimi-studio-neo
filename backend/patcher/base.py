...
class ModelPatcher:
    ...
    def model_patches_call_function(self, function_name="cleanup", arguments=None):
    ...
    def unpatch_model(self, device_to=None, unpatch_weights=True):
        if unpatch_weights:
            ...
            for module in model_modules:
                if hasattr(module, "forge_patched_weights"):
                    del module.forge_patched_weights
